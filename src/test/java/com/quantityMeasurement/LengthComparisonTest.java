...
public class LengthComparisonTest {
    ...
    void given0CentimeterAnd0Centimeter_ShouldReturnEqual() {
        Length cm1 = new Length(Unit.CENTI_METER, 0.0);
        Length cm2 = new Length(Unit.CENTI_METER, 0.0);
    ...
    void given0CentimeterAnd1Centimeter_ShouldReturnNotEqual() {
        Length cm1 = new Length(Unit.CENTI_METER, 0.0);
        Length cm2 = new Length(Unit.CENTI_METER, 1.0);
    ...
    void given2InchAnd5Cm_WhenCompared_ShouldReturnEqualLength() {
        ...
        Length cm = new Length(Unit.CENTI_METER, 5.0);
    ...
    void given2InchAnd2Inch_WhenAdded_ShouldReturn4Inch() {
        ...
        Length expectedSum = new Length(Unit.INCH, 4.0);
    ...
    void given1FeetAnd2Inch_WhenAdded_ShouldReturn14Inch() {
        Length feet = new Length(Unit.FEET, 1.0);
        Length inch = new Length(Unit.INCH, 2.0);
        Length expectedSum = new Length(Unit.INCH, 14.0);
    ...
    void given1FeetAnd1Feet_WhenAdded_ShouldReturn24Inch() {
        ...
        Length feet2 = new Length(Unit.FEET, 1.0);
        Length expectedSum = new Length(Unit.INCH, 24.0);
    ...
    void given2Inch2$5Cm_WhenAdded_ShouldReturn3Inch() {
        Length inch = new Length(Unit.INCH, 2.0);
        Length cm = new Length(Unit.CENTI_METER, 2.5);
        Length expectedSum = new Length(Unit.INCH, 3.0);
